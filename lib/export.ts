...
export async function createXlsxExport() {
  ...
  add("主题设置", ["网站名称","网站副标题","背景类型","电脑背景地址","手机背景地址","主色","辅助色","强调色","页面背景色","卡片透明度","遮罩强度","更新时间"], settingsRows.map((s) => [s.siteName,s.siteTagline,s.backgroundType,s.backgroundImageUrl,s.backgroundImageMobileUrl,s.primaryColor,s.secondaryColor,s.accentColor,s.backgroundColor,s.cardOpacity,s.backgroundOverlay,s.updatedAt]));
