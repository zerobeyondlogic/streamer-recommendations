...
export const siteSettings = pgTable("site_settings", {
  ...
  filterOpacity: numeric("filter_opacity", { precision: 3, scale: 2 }).notNull().default("0.72"),
  cardOpacity: numeric("card_opacity", { precision: 3, scale: 2 }).notNull().default("0.94"),
  navBlur: boolean("nav_blur").notNull().default(false),
...
export const siteCopySettings = pgTable("site_copy_settings", {
  ...
  recommendationTagline: text("recommendation_tagline").notNull().default("书籍、漫画、电影、动漫和游戏都可以投稿。"),
