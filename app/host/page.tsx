...
export default async function HostDashboard() {
  ...
  const [newCount,pending,progress,completed,pinned,unread,marshmallowCount,hostMusingCount] = await getHostStats(host.id);
  const stats=[
    ...
    {label:'未读通知',value:unread,href:'/me/notifications?unread=1',Icon:Bell},
  ];
