...
import { Bell, BookOpen, ClipboardList, Film, Gamepad2, House, Images, LayoutDashboard, LogIn, LogOut, MessageCircleHeart, Send, Tv, UserPlus } from "lucide-react";
        ...
        <header className="site-header">
          <nav className="nav-shell" aria-label="主导航">
            ...
            <div className="nav-links account-links">
              <Link href="/marshmallow" aria-label="棉花糖"><MessageCircleHeart className="nav-icon" aria-hidden="true"/><span className="nav-action-label">棉花糖</span></Link>
              ...
              {user?.role === "host" ? <Link href="/host" aria-label="神绮爱工作台"><LayoutDashboard className="nav-icon" aria-hidden="true"/><span className="nav-action-label">工作台</span></Link> : null}
