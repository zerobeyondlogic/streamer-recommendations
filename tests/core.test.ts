...
describe("账号与输入安全",()=>{
  ...
  it("拒绝明显越界的层级透明度",()=>expect(appearanceSchema.safeParse({navOpacity:.9,heroOpacity:.9,filterOpacity:.7,cardOpacity:.2,navBlur:false,heroBlur:false,filterBlur:false,cardBlur:false}).success).toBe(false));
  it("允许四种层级最低设置为 0.3",()=>expect(appearanceSchema.safeParse({navOpacity:.3,heroOpacity:.3,filterOpacity:.3,cardOpacity:.3,navBlur:true,heroBlur:false,filterBlur:false,cardBlur:true}).success).toBe(true));
